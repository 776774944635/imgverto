                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-center justify-between p-6 bg-muted/30 rounded-3xl border border-border/50">
                                        ...
                                        <button
                                            ...
                                            className="w-full md:w-auto px-10 py-4 rounded-2xl bg-primary text-primary-foreground font-extrabold text-lg hover:opacity-90 disabled:opacity-50 transition-all shadow-xl active:scale-95 flex items-center gap-3 justify-center"
                                        >
                                            {isProcessing ? (
                                                <>
                                    ...
                                    {upscaledUrl && (
                                        <div className="flex justify-center pt-6 border-t border-border/10">
                                            <a
                                                ...
                                                className="px-10 py-4 rounded-full bg-emerald-500 text-white font-extrabold text-lg hover:bg-emerald-600 transition-all flex items-center gap-2 shadow-2xl active:scale-95"
                                            >
