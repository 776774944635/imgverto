                                    ...
                                    <div className="space-y-10">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-6 items-center justify-between p-6 bg-muted/30 rounded-3xl border border-border/50">
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    "px-10 py-4 rounded-2xl font-extrabold text-lg transition-all shadow-xl flex items-center gap-3",
                                                    pngUrl
                                        ...
                                        {pngUrl && (
                                            <div className="flex justify-center pt-6 border-t border-border/10">
                                                <a
                                                    ...
                                                    className="px-12 py-5 rounded-full bg-primary text-primary-foreground font-extrabold text-xl hover:opacity-90 transition-all flex items-center gap-3 shadow-2xl active:scale-95"
                                                >
