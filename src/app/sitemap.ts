...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const routes = [
        ...
        '/blog/neet-ug-photo-signature-requirements',
        '/blog/upsc-cse-photo-signature-requirements',
        '/blog/ssc-cgl-photo-signature-requirements',
        '/blog/nda-photo-signature-requirements',
        '/blog/ibps-sbi-banking-photo-signature-requirements',
        '/blog/indian-govt-schemes-photo-requirements',
        '/blog/rrb-ntpc-group-d-photo-signature-requirements',
        '/blog/pm-kisan-photo-document-requirements',
        '/blog/state-psc-photo-signature-requirements',
        '/blog/board-exams-photo-signature-requirements',
        // Pages
        '/about',
        '/contact',
        '/privacy',
