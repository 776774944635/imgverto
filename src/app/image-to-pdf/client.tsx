                ...
                <div className="grid grid-cols-1 lg:grid-cols-[160px_1fr_160px] gap-6">
                    ...
                    <div className="flex flex-col items-center pt-4">
                        ...
                        {items.length === 0 ? (
                            ...
                            <div className="w-full max-w-4xl mx-auto premium-card rounded-[2.5rem] bg-white overflow-hidden min-h-[400px] p-6 space-y-6 mb-8 relative shadow-2xl">
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-500 to-red-500" />
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <h3 className="font-semibold text-sm">Pages ({items.length})</h3>
                                    ...
                                    <div className="flex justify-center pt-2">
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-8 py-3 rounded-full font-extrabold bg-primary text-primary-foreground hover:opacity-90 transition-transform active:scale-95 text-base shadow-xl"
                                        >
