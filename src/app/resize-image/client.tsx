                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                                            <div className="space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="space-y-1.5">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full p-2.5 rounded-xl border bg-background focus:ring-2 focus:ring-primary/20 outline-none transition-all text-sm"
                                                        />
                                                    </div>
                                                    <div className="space-y-1.5">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full py-3 rounded-2xl bg-primary text-primary-foreground font-extrabold text-base hover:opacity-90 disabled:opacity-50 transition-all shadow-xl active:scale-95"
                                                >
                                        ...
                                        {resizedUrl && (
                                            <div className="flex justify-center pt-4 border-t border-border/10">
                                                <a
                                                    ...
                                                    className="px-8 py-3 rounded-full bg-primary text-primary-foreground font-extrabold text-base hover:opacity-90 transition-all flex items-center gap-2 shadow-2xl active:scale-95"
                                                >
